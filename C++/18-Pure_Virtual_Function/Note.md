...
2. It allows us to define a `function` in a `base clas`s that **does not** have an implementation and then **forces** `subclasses` to actually implement that `function`.
