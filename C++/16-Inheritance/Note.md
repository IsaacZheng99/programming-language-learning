...
1. `polymorphism`
2. `inheritance`
3. `subclass and parent class`
4. `function with parent-class-typed parameter`
...
2. A `function` with `Entity-typed` parameter can also accept `Player-typed` value, but the reverse is not true: 
